# netlify/functions/transcribe_py.py
# Netlify Python functions must be a flat .py file with a handler(event, context) function.
import json
import base64
import tempfile
import os
...
def handler(event, context):
    ...
    try:
        ...
        try:
            ...
            # Map BCP-47 to Google language code (most match directly, add -IN if no region)
